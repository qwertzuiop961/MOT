...
${}^{87}$Rb ist ein Alkalimetall mit einem Elektron in der äußersten, der vierten Schale. Im Grundzustand $5S_{1/2}$ besitzt das Atom einen Drehimpuls
  ...
  \label{fvonv}
  \end{figure}
\\Für eine MOT mit Rb-Atomen benötigt man zwei Laser, die leicht unterschiedlichen Frequenzen (Frequenzabstand ${\Delta}$ = 2.9 GHz) haben. Die sättigungsspektroskopisch werden stabilisiert, um die Laser in richtigen Frequenz zu betreiben.
